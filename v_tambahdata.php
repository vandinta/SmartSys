...
<script>
  ...
  // function Hitung(select) {
  //   var produk = select.value;
  //   var xhr = new XMLHttpRequest();
  //   xhr.onreadystatechange = function() {
  //     if (xhr.readyState == 4 && xhr.status == 200) {
  //       var data = JSON.parse(xhr.responseText);
  //       var row = select.parentNode.parentNode;
  //       var hargaInput = row.querySelector('input[name="harga_barang[]"]');
  //       hargaInput.value = data.harga;
  //     }
  //   };
  //   xhr.open("GET", "getHarga.php?produk=" + produk, true);
  //   xhr.send();
  // }
  ...
  //       var hargaInput = row.find('input[name="harga_barang[]"]');
  ...
  // var selection = document.getElementById("id_barang");
