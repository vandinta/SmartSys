      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            ...
            <a href="<?php echo base_url('/datapenjualan/tambah') ?>" type="button" class="btn btn-primary btn-round ml-2" <?php if ($_SESSION['role'] == "superadmin") {
                                                                                                                              echo "hidden";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="nav nav-pills nav-secondary nav-pills-no-bd nav-pills-icons justify-content-center" id="pills-tab-with-icon">
          <li class="nav-item">
            <a class="" href="<?= base_url('/datapenjualan/exportcsv') ?>">
              <button type="button" class="btn btn-outline-primary" style="width: 90px; text-align: center;">
                <i class="fa fa-file-code"></i>
                CSV
              </button>
          ...
          <li class="nav-item">
            <a class="" href="<?= base_url('/datapenjualan/exportexcel') ?>">
              <button type="button" class="btn btn-outline-primary" style="width: 90px; text-align: center;">
                <i class="fa fa-file-excel"></i>
                EXCEL
              </button>
          ...
          <li class="nav-item">
            <a class="" href="<?= base_url('/datapenjualan/exportpdf') ?>">
              <button type="button" class="btn btn-outline-primary" style="width: 90px; text-align: center;">
...
<div class="modal fade" id="inputModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('/datapenjualan/import') ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>
        <div class="modal-body">
